...
export class TipoProductoService {
  recurosBaseURL: string ="http://127.0.0.1:8084/api/tipos-producto/listar"//"../../assets/data/tipo-producto.json" //environment.URL_BASE + '/areas/';
    ...
    return this.http.get(this.recurosBaseURL, {params: filtros})
               .pipe( 
                 map((r:any) => {
                   ...
                   const data = respuesta.lista.slice (inicio,fin)
